...
export const textDefaultColor = 'white';
export const textColor = '#43515c';
// export const textLinkColor = '#00adf5';
export const textLinkColor = 'white';
...
export const textDayFontSize = 17;
export const textMonthFontSize = 17;
...
export const textSectionTitleColor = 'white';
